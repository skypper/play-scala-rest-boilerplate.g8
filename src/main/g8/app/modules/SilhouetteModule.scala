...
import models.daos.{ AuthTokenDAO, AuthTokenDAOImpl, CredentialsAuthInfoDAOImpl, SocialAuthInfoDAOImpl, UserDAO, UserDAOImpl }
...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  override def configure(): Unit = {
    ...
    bind[DelegableAuthInfoDAO[PasswordInfo]].to[CredentialsAuthInfoDAOImpl]
   ...
   *
   * @param passwordInfoDAO The implementation of the delegable password utils.auth info DAO.
   * @param oauth1InfoDAO The implementation of the delegable OAuth1 utils.auth info DAO.
   * @param oauth2InfoDAO The implementation of the delegable OAuth2 utils.auth info DAO.
   * @param openIDInfoDAO The implementation of the delegable OpenID utils.auth info DAO.
   ...
   *
   * @param authInfoRepository The utils.auth info repository implementation.
